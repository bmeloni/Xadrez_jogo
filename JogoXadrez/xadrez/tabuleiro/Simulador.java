 ...
 * 
 * Serve pra testarmos à vontade os domínios e posições das peças, fazendo-se uma "cópia"
 * do tabuleiro e mexendo nessa, sem bagunçar o jogo em si! Esses testes são úteis pra
 * determinar se movimento é permitido, no caso de não deixar o próprio rei em xeque ;
 */
...
public class Simulador {
	...
	private Point rei_branco, rei_preto; /// Posição dos Reis: pq se é ele que move, muda sua posição 
	...
	/**
	 * Primeiro precisamos copiar o tabuleiro pra podermos jogar
	 */
